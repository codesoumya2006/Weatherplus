            ...
            fetchData(url.geo(searchField.value), function (locations) {
                ...
                for (const { name, lat, lon, country, state } of locations) {
                    ...
                    searchItem.innerHTML = `
                        ...
                        <a href="#/weather?lat=${lat}&lon=${lon}" class="item-link has-state" aria-label="${name}'s weather" data-search-toggler></a>
                    `;
    ...
    fetchData(url.currentWeather(lat, lon), function (currentWeather) {
        ...
        fetchData(url.forecast(lat, lon), function (forecast) {
            ...
            `;
                ...
                /**
                 * Hourly Section Horizontal Drag Scroll on mouse events
                 */
                // const slider = hourlySection.querySelector(".slider-container");
                // let isDown = false;
                // let startX;
                // let scrollLeft;
